...
<<<<<<< HEAD
ActiveRecord::Schema.define(version: 20150923013228) do
=======
ActiveRecord::Schema.define(version: 20150923031347) do
>>>>>>> master
  ...
  create_table "categories_ideas_table", force: :cascade do |t|
    t.integer "item_id"
